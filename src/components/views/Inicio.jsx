    ...
    <div className="mainSection">
      <div className=" text-light portada ">
        <div className="subPortada">
          <h1 className="display-1">Comidas Arabes</h1>
        </div>
      </div>
            ...
            <Col md={4}>
              <Card  className="cardCirculo ms-5">
                <div className="imgCardP">
                  <div>
                  <Button as={Link} to="/login" className="btnMenu"><i class="bi bi-people-fill text-light display-4 iconMenu"></i></Button>
                  </div>
                  <Card.Img variant="top" src="" />
                </div>
                <Card.Body className="bodyCard">
                  <Card.Title className="text-light my-3"> login</Card.Title>
                  <Link variant="warning" to="/nosotros" className="btn btn-warning">Ver mas</Link>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="cardCirculo ms-5">
                <div className="imgCardP">
                 <div>
                   <Button as={Link} to="/nosotros" className="btnMenu"><i class="bi bi-book text-light display-4 iconMenu"></i></Button>
                  </div>
                </div>
                <Card.Body className="bodyCard">
                  <Card.Title className="text-light my-3">Nosotros</Card.Title>
                  <Link variant="warning" className="btn btn-warning">Ver mas</Link>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card  className="cardCirculo ms-3">
                <div className="imgCardP">
                <div>
                <Button as={Link} className="btnMenu"><i class="bi bi-cart text-light display-4 iconMenu"></i></Button>
                  </div>
                </div>
                <Card.Body className="bodyCard">
      ...
      <div className="portada2 ">
        <div className="divPortada2">
          <h1 className="display-2 text-light">Descubri nuestras especialidades</h1>
